...
export class OrderService {
  ...
  public changeStatus(sku: string, status: string, username:string): Observable<any> {
    return this.http.post(`http://localhost:8080/api/v1/orders/changeStatus/${sku}/${status}/${username}`, { username});
  }
